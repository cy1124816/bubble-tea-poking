...
// 糖度选项（按优先级排序，避免误匹配）
// 包含各种商家的甜度表述方式，统一映射到标准格式
const SUGAR_OPTIONS = [
  // 七分糖 / 少糖
  {
    keywords: ['7分糖', '七分糖', '少糖', '70%糖', '七成糖'],
    value: '七分糖',
    pattern: /[7七]分?糖|少糖|70%?糖|七成糖/
  },
  // 五分糖 / 半糖
  {
    keywords: ['5分糖', '五分糖', '半糖', '50%糖', '五成糖'],
    value: '五分糖',
    pattern: /[5五]分?糖|半糖|50%?糖|五成糖/
  },
  // 三分糖 / 微糖
  {
    keywords: ['3分糖', '三分糖', '微糖', '30%糖', '三成糖', '少少糖'],
    value: '三分糖',
    pattern: /[3三]分?糖|微糖|30%?糖|三成糖|少少糖/
  },
  // 无糖
  {
    keywords: ['0糖', '零糖', '无糖', '不加糖', '0%糖'],
    value: '无糖',
    pattern: /[0零]糖|无糖|不加糖|0%?糖/
  },
  // 标准糖 / 正常糖 / 全糖
  {
    keywords: ['正常糖', '标准糖', '全糖', '10分糖', '十分糖', '100%糖', '正常', '标准'],
    value: '标准',
    pattern: /正常糖?|标准糖?|全糖|10分?糖|十分?糖|100%?糖/
  },
];
